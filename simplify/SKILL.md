---
name: simplify
description: Review all changed files for reuse, quality, and efficiency, then fix any issues found. Use when the user asks to simplify, clean up, review code quality, or refactor changed code. Also use after implementing a feature when the user wants a quality pass.
tools: Bash, Glob, Grep, Read, Edit, Agent
---
